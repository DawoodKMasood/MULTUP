    ...
    <>
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <div className="bg-white rounded-lg border border-zinc-300 overflow-hidden">
          <div className="px-6 py-4 border-b border-zinc-300 bg-gray-50">
            ...
            <p className="text-sm text-gray-500 mt-2">
              File: <span className="font-medium text-gray-700">{file.filename}</span>
            </p>
          </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  value={mirrorUrl}
                  readOnly
                  className="flex-1 px-3 py-2 border border-zinc-300 rounded-md bg-gray-50 text-gray-600 text-sm focus:outline-none"
                />
                <button
                  onClick={copyToClipboard}
                  className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-md border border-zinc-300 transition-colors whitespace-nowrap"
                >
                  {copied ? 'Copied!' : 'Copy'}
                </button>
              </div>
