    ...
    <>
      ...
      <div className="max-w-6xl mx-auto py-8 px-4">
        <div className="bg-white mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">{file.filename}</h1>
        ...
        <div className="bg-white rounded-lg border border-zinc-300 overflow-hidden">
          <div className="px-6 py-4 border-b border-zinc-300 overflow-hidden">
                    ...
                    <tr key={mirror.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {mirror.status === 'done' ? (
                          ...
                          <span className="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-400 text-sm font-medium rounded cursor-not-allowed">
                            Unavailable
                          </span>
                        )}
                      </td>
